...
public final class Zoo {
    ...
    public boolean adaugaAnimal(Animal a) throws NumeDuplicatException {
        if (a == null) {
            ...
            throw new NullPointerException("Animalul nu poate fi null");
        }
        ...
        for (int i = 0; i < count; i++) {
            if (animale[i].equals(a)) {
                ...
                throw new NumeDuplicatException();
            }
        }
    ...
    public Animal stergeAnimal(int id) throws IdInexistentException {
        Animal aux = null;
        int index = -1;
        ...
        if (index == -1) { 
            ...
            throw new IdInexistentException();
        }
